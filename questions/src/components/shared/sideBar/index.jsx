    ...
    <div className="dlabnav">
      <div className="dlabnav-scroll mm-active ps ps--active-y">
        ...
        <ul className="metismenu mm-show" id="menu">
          ...
          <li className="mm-active"><a className="has-arrow " href="#" aria-expanded="false">
            <i className="flaticon-086-star"></i>
            <span className="nav-text">Bootstrap</span>
          </a>
            <ul aria-expanded="false" className="mm-collapse mm-show left" >
              <li className="mm-active"><a href="./ui-accordion.html" className="mm-active">Accordion</a></li>
